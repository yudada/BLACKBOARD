<template>
  <div class="publish_main">
    ...
    <div class="publish_concent">
      <el-row>
        <el-col :span="24">
          <el-card :body-style="{ padding: '40px'}">
            <el-form ref="publishFormRef" :model="publishForm" :rules="publishFormRules" label-position="top">
              <el-form-item label="作业名称" prop="exeTitle">
                <el-input placeholder="例：周三课后练习题" v-model="publishForm.exeTitle" class="set_w"></el-input>
              </el-form-item>
              <el-form-item label="开始时间" prop="exeStartTime">
                <el-date-picker
              ...
              <el-form-item label="结束时间" prop="exeEndTime">
                <el-date-picker
              ...
              <el-form-item label="班级" prop="class_id">
                <el-select clearable v-model="publishForm.class_id" placeholder="请选择班级">
                  <el-option
              ...
              <el-form-item label="课本" prop="textbook_id">
                <el-select clearable v-model="publishForm.textbook_id" placeholder="请选择课本">
                  <el-option
              ...
              <el-form-item label="作业类型" prop="exeType">
                <el-select clearable v-model="publishForm.exeType" placeholder="请选择作业类型">
                  <el-option
      ...
      <!-- 作业内容弹框 -->
      <el-dialog  title="请选择内容:" :visible.sync="contentDialogVisible" width="80%" top="5vh" :append-to-body="true" :close-on-click-modal="false" :destroy-on-close="true">
...
export default {
  ...
  data() {
    return {
      ...
      endTime: {
        disabledDate: (time) => {
          return time.getTime() < this.publishForm.exeStartTime || time.getTime() < Date.now() - 8.64e7;
        }
      },
      // 模型列表
      modelsList: [],
