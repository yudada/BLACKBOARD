...
function inputChangCarry(newcarry, ent) {
    ...
    document.calc.sin.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e5btn.jpg) no-repeat 0 -34px";
    document.calc.cos.style.color = (carry != 10) ? "#aca899" : "#fff";
    document.calc.cos.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e5btn.jpg) no-repeat 0 -34px";
    document.calc.tan.style.color = (carry != 10) ? "#aca899" : "#fff";
    document.calc.tan.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e5btn.jpg) no-repeat 0 -34px";
    document.calc.bt.style.color = (carry != 10) ? "#aca899" : "#fff";
    document.calc.bt.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e5btn.jpg) no-repeat 0 -34px";
    document.calc.pi.style.color = (carry != 10) ? "#aca899" : "#fff";
    document.calc.pi.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e5btn.jpg) no-repeat 0 -34px";
    document.calc.e.style.color = (carry != 10) ? "#aca899" : "#fff";
    document.calc.e.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e5btn.jpg) no-repeat 0 -34px";
    document.calc.kp.style.color = (carry != 10) ? "#aca899" : "#fff";
    document.calc.kp.style.background = (carry != 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k2.style.color = (carry <= 2) ? "#aca899" : "#fff";
    document.calc.k2.style.background = (carry <= 2) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k3.style.color = (carry <= 2) ? "#aca899" : "#fff";
    document.calc.k3.style.background = (carry <= 2) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k4.style.color = (carry <= 2) ? "#aca899" : "#fff";
    document.calc.k4.style.background = (carry <= 2) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k5.style.color = (carry <= 2) ? "#aca899" : "#fff";
    document.calc.k5.style.background = (carry <= 2) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k6.style.color = (carry <= 2) ? "#aca899" : "#fff";
    document.calc.k6.style.background = (carry <= 2) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k7.style.color = (carry <= 2) ? "#aca899" : "#fff";
    document.calc.k7.style.background = (carry <= 2) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k8.style.color = (carry <= 8) ? "#aca899" : "#fff";
    document.calc.k8.style.background = (carry <= 8) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.k9.style.color = (carry <= 8) ? "#aca899" : "#fff";
    document.calc.k9.style.background = (carry <= 8) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e3btn.gif) no-repeat 0 -34px";
    document.calc.ka.style.color = (carry <= 10) ? "#aca899" : "#fff";
    document.calc.ka.style.background = (carry <= 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e0btn.gif) no-repeat 0 -34px";
    document.calc.kb.style.color = (carry <= 10) ? "#aca899" : "#fff";
    document.calc.kb.style.background = (carry <= 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e0btn.gif) no-repeat 0 -34px";
    document.calc.kc.style.color = (carry <= 10) ? "#aca899" : "#fff";
    document.calc.kc.style.background = (carry <= 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e0btn.gif) no-repeat 0 -34px";
    document.calc.kd.style.color = (carry <= 10) ? "#aca899" : "#fff";
    document.calc.kd.style.background = (carry <= 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e0btn.gif) no-repeat 0 -34px";
    document.calc.ke.style.color = (carry <= 10) ? "#aca899" : "#fff";
    document.calc.ke.style.background = (carry <= 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e0btn.gif) no-repeat 0 -34px";
    document.calc.kf.style.color = (carry <= 10) ? "#aca899" : "#fff";
    document.calc.kf.style.background = (carry <= 10) ? "url(jisuanqi/e0btn.gif) no-repeat 0 0px" : "url(jisuanqi/e0btn.gif) no-repeat 0 -34px";
...
var showCalculator = function (idx, obj) {
    ...
    if (idx) {
        ...
        //sc_get("calculator_complete_container").style.backgroundImage = "url(jisuanqi/siverbg2.png)";
        bdjs.setHeight(585);
    } else {
